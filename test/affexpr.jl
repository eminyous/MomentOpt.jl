@testset "Expressions" begin
    @testset "AbstractGMPExpr Types" begin
        @testset "ObjectExpr" begin
            ...
            o2 = (μ + ν) / 2
            @test_broken eltype([μ, o2]) ==
                         MomentOpt.ObjectExpr{typeof(1.0),MO.AbstractGMPMeasure}
