@testset "GMPModel" begin
    ...
    @testset "Objective" begin
        ...
        @test JuMP.objective_function(m, MO.MomentExpr{Int}) ==
              Mom(1, mus[1]) + Mom(1, mus[2])
    end
    ...
    @testset "Get Value" begin
        ...
        @test_logs (
            :warn,
            "Requested approximation degree -1 is too low to cover all data. The approximation degree has been set to the minimal value possible and now is 0.",
