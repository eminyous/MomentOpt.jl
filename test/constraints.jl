@testset "Constraints" begin
    @testset "MomentConstraint" begin
        ...
        @test JuMP.reshape_set(MOI.EqualTo(0), MO.MomentConstraintShape()) ==
              MOI.EqualTo(0)
    ...
    @testset "MeasureConstraint" begin
        ...
        @test JuMP.reshape_set(
            ZeroMeasure([x]),
            MO.MeasureConstraintShape(),
        ) isa AnalyticMeasure
        ...
        _err = x -> ""
        @test JuMP.build_constraint(_err, μ + ν, MOI.EqualTo(0)) isa
